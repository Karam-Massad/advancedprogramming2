...
public class Welcome {
	...
	public static void main(String[] args) {
		...
		btnAddStudent.setPreferredSize(new Dimension(175, 25));
		btnDeleteStudent.setPreferredSize(new Dimension(175, 25));
		btnFindStudent.setPreferredSize(new Dimension(175, 25));
		btnShowAll.setPreferredSize(new Dimension(175, 25));
