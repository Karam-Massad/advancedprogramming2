...
public class DeliveryManager {
	...
	protected void calcualtetax(){
		System.out.println("Calculating the Tax...");
	}
	protected void checkPromocode(){
		System.out.println("Checking if promocode found...");
	}
	protected void checkTotalAmmount(){
		System.out.println("Total Ammount...");
	}
	protected void checkPackageSent(){
		System.out.println("Package went through  ....");
	}
	protected void done(String a,String b,String c) {
		
		System.out.println("from "+a+" to "+b+" and it is "+c);
	}
